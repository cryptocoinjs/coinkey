...
function CoinKey (bytes, compressed, versions) {
  ...
  this.fn = {}
  this.fn.toWif = coinstring(this._versions.private);
  this.fn.toAddress = coinstring(this._versions.public);
}
...
Object.defineProperty(CoinKey.prototype, 'privateWif', {
  get: function() {
    return this.fn.toWif(this.privateExportKey);
  }
})

Object.defineProperty(CoinKey.prototype, 'publicAddress', {
  get: function() {
    return this.fn.toAddress(this.pubKeyHash);
  }
})
